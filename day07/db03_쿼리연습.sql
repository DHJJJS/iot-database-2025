...
/* 문제2 - Employees 에서 모든 사원의 last_name과 '이름: 1 Year Salary = $연봉' 형식으로 출력하고, 1 Year Salary라는 별칭으로 붙이세요.(107해)
*/
...
*/
select addtime(sysdate(), 9 hour) as 'sysdate()';
...
select *
  from departments as d join employees as e
    on d.department_id = e.department_id; -- ANSI Standard SQL 쿼리 (잘 안씀)
